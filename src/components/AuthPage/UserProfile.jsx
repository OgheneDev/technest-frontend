        ...
        <div className="p-4">
          ...
          <div className="flex items-center space-x-2 mb-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-grey text-[10px]  md:w-auto break-words flex gap-2 items-center font-semibold">
                <Mail size={15} />
                {userData.email}
              </p>
              <p className="text-grey text-[10px] flex gap-2 items-center font-semibold">
                <Phone size={15} />
