    ...
    <>
      {layout === "grid" ? (
        <motion.div
          ...
          className="group bg-white/10 backdrop-blur-sm rounded-lg border border-white/10 overflow-hidden hover:border-emerald-500/30 hover:shadow-lg hover:shadow-emerald-500/10 transition-all duration-300"
        >
          ...
          <div className="p-4 space-y-3">
            <div>
              <h3 className="font-semibold text-white line-clamp-2 mb-1 group-hover:text-emerald-400 transition-colors">
                {product.name}
              </h3>
            ...
            <Button
              ...
              className={`w-full transition-all duration-300 cursor-pointer text-sm ${
                isOutOfStock
                  ...
                  : "bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 text-white hover:border-emerald-500/50"
              }`}
            >
              {isAddingToCart ? (
