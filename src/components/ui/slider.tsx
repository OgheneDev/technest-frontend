  ...
  return (
    <div className={`relative h-11 w-full touch-none ${className}`}>
      ...
      {[0, 1].map((index) => (
        <div
          key={index}
          className="absolute top-1/2 h-6 w-6 cursor-pointer rounded-full border border-emerald-600 bg-white -translate-x-1/2 -translate-y-1/2 transition-shadow hover:shadow-lg focus:outline-none touch-none"
