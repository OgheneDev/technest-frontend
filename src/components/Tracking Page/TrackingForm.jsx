...
const TrackingForm = () => {
  return (
    <div className='text-grey pb-[40px]'>
      ...
      <form action="" className='flex flex-col gap-5 items-start'>
        <div className="form-group flex flex-col gap-1 text-[13px]">
            ...
            <input type="text" className='border p-2 py-3 placeholder:text-[13px]' placeholder='Found in your order code confirmation email.' />
        </div>
        ...
        <button className='bg-black text-white py-3 px-10 font-bold uppercase'>Order Track</button>
      </form>
    </div>
  )
}
